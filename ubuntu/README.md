...
```text
ubuntu/dist/flowvoice_1.6.0_amd64.deb
```
...
- Para publicar atualizações automáticas no Ubuntu, anexe o `.deb` gerado na release do GitHub com o nome `flowvoice_1.6.0_amd64.deb` (versão em `version.py`).
