...
### Ubuntu — gerar `flowvoice_1.8.1_amd64.deb`
...
**Saída:**
- Pacote: `ubuntu/dist/flowvoice_1.8.1_amd64.deb`
...
Release notes da versão atual: [releases/1.8.1.md](file:///c:/Dev/ST/releases/1.8.1.md)
